    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li role="presentation" class="{{ Request::is('users/*/followers') ? 'active' : '' }}"><a href="{{ route('users.favorite', ['id' => $user->id]) }}">Favorites <span class="badge">{{ $count_favorite }}</span></a></li>
            </ul>
